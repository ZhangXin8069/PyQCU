print(
    '''
    @@@@@@######QCU NOTES START######@@@@@@@
    0. Required: MPI(eq-4.1.2), CUDA(eq-12.4), CMAKE(eq-3.22.1), GCC(eq-11.4.0), HDF5-MPI(eq-1.10.7,'apt install libhdf5-mpi-dev && export HDF5_MPI="ON" && pip install --no-binary=h5py h5py').

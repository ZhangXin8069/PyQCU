...
template __global__ void cg_give_b_e<double>(void *device_b_e,
                                             void *device_ans_e,
                                             void *device_vec0, double kappa,
                                             void *device_vals);
template __global__ void cg_give_b_o<double>(void *device_b_o,
                                             void *device_ans_o,
                                             void *device_vec1, double kappa,
                                             void *device_vals);
template __global__ void cg_give_b__o<double>(void *device_b__o,
                                              void *device_b_o,
                                              void *device_vec0, double kappa,
                                              void *device_vals);
template __global__ void cg_give_r<double>(void *device_r, void *device_b__o,
                                           void *device_vec1,
                                           void *device_vals);
template __global__ void cg_give_dest_o<double>(void *device_dest_o,
                                                void *device_src_o,
                                                void *device_vec1, double kappa,
                                                void *device_vals);
...
template __global__ void cg_give_b_e<float>(void *device_b_e,
                                            ...
                                            void *device_vals);
template __global__ void cg_give_b_o<float>(void *device_b_o,
                                            void *device_ans_o,
                                            void *device_vec1, float kappa,
                                            void *device_vals);
template __global__ void cg_give_b__o<float>(void *device_b__o,
                                             void *device_b_o,
                                             void *device_vec0, float kappa,
                                             void *device_vals);
template __global__ void cg_give_r<float>(void *device_r, void *device_b__o,
                                          void *device_vec1, void *device_vals);
template __global__ void cg_give_dest_o<float>(void *device_dest_o,
                                               void *device_src_o,
                                               void *device_vec1, float kappa,
                                               void *device_vals);

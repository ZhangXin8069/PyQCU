...
template <typename T> struct LatticeSet {
  ...
  void _print() {
    ...
    printf("gridDim_2dim[_XY_]           :%d\n", gridDim_2dim[_XY_]);
    printf("gridDim_2dim[_XZ_]           :%d\n", gridDim_2dim[_XZ_]);
    printf("gridDim_2dim[_XT_]           :%d\n", gridDim_2dim[_XT_]);
    printf("gridDim_2dim[_YZ_]           :%d\n", gridDim_2dim[_YZ_]);
    printf("gridDim_2dim[_YT_]           :%d\n", gridDim_2dim[_YT_]);
    printf("gridDim_2dim[_ZT_]           :%d\n", gridDim_2dim[_ZT_]);
    printf("gridDim_3dim[_YZT_]          :%d\n", gridDim_3dim[_YZT_]);
    printf("gridDim_3dim[_XZT_]          :%d\n", gridDim_3dim[_XZT_]);
    printf("gridDim_3dim[_XYT_]          :%d\n", gridDim_3dim[_XYT_]);
    printf("gridDim_3dim[_XYZ_]          :%d\n", gridDim_3dim[_XYZ_]);

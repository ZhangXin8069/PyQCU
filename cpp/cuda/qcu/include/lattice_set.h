...
template <typename T> struct LatticeSet {
  ...
  void _print() {
    ...
    printf("gridDim_2dim[_XY_].x         :%d\n", gridDim_2dim[_XY_].x);
    printf("gridDim_2dim[_XZ_].x         :%d\n", gridDim_2dim[_XZ_].x);
    printf("gridDim_2dim[_XT_].x         :%d\n", gridDim_2dim[_XT_].x);
    printf("gridDim_2dim[_YZ_].x         :%d\n", gridDim_2dim[_YZ_].x);
    printf("gridDim_2dim[_YT_].x         :%d\n", gridDim_2dim[_YT_].x);
    printf("gridDim_2dim[_ZT_].x         :%d\n", gridDim_2dim[_ZT_].x);
    printf("gridDim_3dim[_YZT_].x        :%d\n", gridDim_3dim[_YZT_].x);
    printf("gridDim_3dim[_XZT_].x        :%d\n", gridDim_3dim[_XZT_].x);
    printf("gridDim_3dim[_XYT_].x        :%d\n", gridDim_3dim[_XYT_].x);
    printf("gridDim_3dim[_XYZ_].x        :%d\n", gridDim_3dim[_XYZ_].x);

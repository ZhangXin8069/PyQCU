...
#include "./include.h"
namespace qcu {
template <typename T> struct LatticeComplex {
  ...
  __host__ __device__ __inline__ T real() const { return _data.x; }
  __host__ __device__ __inline__ T imag() const { return _data.y; }

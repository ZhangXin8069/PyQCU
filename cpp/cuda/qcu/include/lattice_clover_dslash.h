    ...
    {
      {
        ...
        // x edge part comm
        _MPI_Sendrecv<T>(
            set_ptr->host_u_1dim_send_vec[_B_X_],
            set_ptr->lat_3dim[_X_] * _LAT_PCCD_ * _REAL_IMAG_,
            set_ptr->move_wards[_B_X_], 0, set_ptr->host_u_1dim_recv_vec[_F_X_],
            set_ptr->lat_3dim[_X_] * _LAT_PCCD_ * _REAL_IMAG_,
            set_ptr->move_wards[_F_X_], 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
        _MPI_Sendrecv<T>(
            set_ptr->host_u_1dim_send_vec[_F_X_],
            set_ptr->lat_3dim[_X_] * _LAT_PCCD_ * _REAL_IMAG_,
            set_ptr->move_wards[_F_X_], 0, set_ptr->host_u_1dim_recv_vec[_B_X_],
            set_ptr->lat_3dim[_X_] * _LAT_PCCD_ * _REAL_IMAG_,
            set_ptr->move_wards[_B_X_], 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
      }
      {
        // y edge part comm
        _MPI_Sendrecv<T>(
            set_ptr->host_u_1dim_send_vec[_B_Y_],
            set_ptr->lat_3dim[_Y_] * _LAT_PCCD_ * _REAL_IMAG_,
            set_ptr->move_wards[_B_Y_], 0, set_ptr->host_u_1dim_recv_vec[_F_Y_],
            set_ptr->lat_3dim[_Y_] * _LAT_PCCD_ * _REAL_IMAG_,
            set_ptr->move_wards[_F_Y_], 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
        _MPI_Sendrecv<T>(
            set_ptr->host_u_1dim_send_vec[_F_Y_],
            set_ptr->lat_3dim[_Y_] * _LAT_PCCD_ * _REAL_IMAG_,
            set_ptr->move_wards[_F_Y_], 0, set_ptr->host_u_1dim_recv_vec[_B_Y_],
            set_ptr->lat_3dim[_Y_] * _LAT_PCCD_ * _REAL_IMAG_,
            set_ptr->move_wards[_B_Y_], 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
      }
      {
        // z edge part comm
        _MPI_Sendrecv<T>(
            set_ptr->host_u_1dim_send_vec[_B_Z_],
            set_ptr->lat_3dim[_Z_] * _LAT_PCCD_ * _REAL_IMAG_,
            set_ptr->move_wards[_B_Z_], 0, set_ptr->host_u_1dim_recv_vec[_F_Z_],
            set_ptr->lat_3dim[_Z_] * _LAT_PCCD_ * _REAL_IMAG_,
            set_ptr->move_wards[_F_Z_], 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
        _MPI_Sendrecv<T>(
            set_ptr->host_u_1dim_send_vec[_F_Z_],
            set_ptr->lat_3dim[_Z_] * _LAT_PCCD_ * _REAL_IMAG_,
            set_ptr->move_wards[_F_Z_], 0, set_ptr->host_u_1dim_recv_vec[_B_Z_],
            set_ptr->lat_3dim[_Z_] * _LAT_PCCD_ * _REAL_IMAG_,
            set_ptr->move_wards[_B_Z_], 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
      }
      {
        // t edge part comm
        _MPI_Sendrecv<T>(
            set_ptr->host_u_1dim_send_vec[_B_T_],
            set_ptr->lat_3dim[_T_] * _LAT_PCCD_ * _REAL_IMAG_,
            set_ptr->move_wards[_B_T_], 0, set_ptr->host_u_1dim_recv_vec[_F_T_],
            set_ptr->lat_3dim[_T_] * _LAT_PCCD_ * _REAL_IMAG_,
            set_ptr->move_wards[_F_T_], 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
        _MPI_Sendrecv<T>(
            set_ptr->host_u_1dim_send_vec[_F_T_],
            set_ptr->lat_3dim[_T_] * _LAT_PCCD_ * _REAL_IMAG_,
            set_ptr->move_wards[_F_T_], 0, set_ptr->host_u_1dim_recv_vec[_B_T_],
            set_ptr->lat_3dim[_T_] * _LAT_PCCD_ * _REAL_IMAG_,
            set_ptr->move_wards[_B_T_], 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
      }
      {
        // u_2dim_comm
        {

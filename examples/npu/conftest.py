...
#             lat_size=[8, 8, 8, 8], device=torch.device('npu'),max_level=1)
# test_solver(method='multigrid', dtype=torch.complex64,
#             lat_size=[8, 8, 8, 8], device=torch.device('npu'),max_level=2)
# test_solver(method='multigrid', dtype=torch.complex64,
#             lat_size=[8, 8, 16, 16], device=torch.device('npu'),max_level=1)
# test_solver(method='multigrid', dtype=torch.complex64,
#             lat_size=[8, 8, 16, 16], device=torch.device('npu'),max_level=2)
# test_solver(method='multigrid', dtype=torch.complex64,
#             lat_size=[8, 8, 8, 16], device=torch.device('npu'),max_level=1)
# test_solver(method='multigrid', dtype=torch.complex64,
#             lat_size=[8, 8, 8, 16], device=torch.device('npu'),max_level=2, num_restart=1)
# test_solver(method='multigrid', dtype=torch.complex64,
#             lat_size=[8, 8, 8, 16], device=torch.device('npu'),max_level=2, num_restart=3)
# test_solver(method='multigrid', dtype=torch.complex64,
#             lat_size=[8, 8, 8, 16], device=torch.device('npu'),max_level=2, num_restart=5)
# test_solver(method='bistabcg', dtype=torch.complex64,

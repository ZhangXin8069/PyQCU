...
foreach(_cmake_expected_target IN ITEMS QMP::qmp)
...
# Create imported target QMP::qmp
add_library(QMP::qmp SHARED IMPORTED)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/QMPTargets-*.cmake")

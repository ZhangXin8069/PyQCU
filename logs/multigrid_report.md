...
|--------|----------|--------------------------|
| BiStabCG | 1.4421 ± 0.0024 | 3.59e-07 |
| Multigrid | 3.5305 ± 1.0832 | 3.46e-07 |

| Comparison | Value |
|------------|-------|
| \|x_mg − x_ref\| / \|x_ref\| | 4.05e-07 |
| Speedup (MG / BiStabCG) | 0.41× |
...
|------|-----------|---------|-------------|--------|---------|----------------------|
| 1 | complex64 | 8×8×8×16 | 1.442 | 3.531 | 0.41× | 4.05e-07 |

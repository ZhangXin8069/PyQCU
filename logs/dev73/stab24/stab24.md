...
> 数据来源：`logs/dev73/`（开发/调试/优化/结果报告，含 `logs/dev73/stab24/` 自身）与 `examples/qcu/dev73/`（测试/基准/剖析脚本）
> LaTeX 版：`logs/dev73/stab24/stab24.tex` → `logs/dev73/stab24/stab24.pdf`（21 页，16 张数据图表，5 张 LaTeX 表格）
...
*LaTeX 编译：`logs/dev73/stab24/stab24.tex` → `logs/dev73/stab24/stab24.pdf`（21 页）*
